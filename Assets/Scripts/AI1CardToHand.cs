...
public class AI1CardToHand : MonoBehaviour
{
    ...
    public void BeingTarget()
    {
        ...
        else
        {
            ...
            {
                if (child.GetComponent<AI1CardToHand>().id == 1 || child.GetComponent<AI1CardToHand>().id == 13 || child.GetComponent<AI1CardToHand>().id == 19)
                {
                    isTarget = false;
                    return;
                }
    ...
    public void HealOne()
    {
        ...
        //     if (i == x)
        //     {
        //         if (child != transform && child.GetComponent<AI1CardToHand>() != null && child.GetComponent<AI1CardToHand>().actualblood > 0)
        //         {
        //             child.GetComponent<AI1CardToHand>().hurted -= healXpower;
        //             break;
        //         }
        //         continue;
        //     }
