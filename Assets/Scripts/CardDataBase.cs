...
public class CardDataBase : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        cardList.Add (new Card(2, "Thầy lang", 1, 2, 1, "Hồi Sức: Tăng 2 máu cho quân lính bất kỳ", Resources.Load<Sprite>("2"), Card.Element.NoElement, 0, 0, 0, 2, false, 0,0));
        cardList.Add (new Card(3, "Thuốc cầm máu 0", 0, 0, 1, "Tăng 3 máu cho quân lính bất kỳ", Resources.Load<Sprite>("3"), Card.Element.NoElement, 0, 0, 0, 3, true, 0,0));
        ...
        cardList.Add (new Card(10, "Thuốc cầm máu 1", 0, 0, 2,"Tăng 3 máu cho 1 quân bất kỳ ,sau đó hồi 2 máu cho hero", Resources.Load <Sprite>("10"), Card.Element.NoElement, 0, 0, 0, 3, true, 0,0));
        ...
        cardList.Add (new Card(20, "Thuốc cầm máu 2", 0, 0, 4, "Tăng 3 máu cho toàn bộ quân lính bên mình", Resources.Load<Sprite>("20"), Card.Element.NoElement, 0, 0, 0, 3, true, 0,0));
