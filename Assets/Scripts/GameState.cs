...
public class GameState
{
    ...
    {   
        deck = new List<ThisCard1>();
        cardsInHand = new List<ThisCard1>();
        cardsInZone = new List<ThisCard1>();
        AIdeck = new List<AICardToHand1>();
        cardsInHandAI = new List<AICardToHand1>();
        cardsInZoneAI = new List<AICardToHand1>();
